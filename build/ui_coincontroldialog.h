...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 PLT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 PLT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 PLT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 PLT"));
    ...
    void retranslateUi(QDialog *CoinControlDialog)
    {
        ...
        ___qtreewidgetitem->setText(4, QApplication::translate("CoinControlDialog", "Darksend Rounds", Q_NULLPTR));
