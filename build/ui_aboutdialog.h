...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Plutus", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Plutus</b> version", 0));
...
"Copyright \302\251 2017 The Plutus developers", 0));
