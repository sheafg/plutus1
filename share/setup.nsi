...
!define MUI_HEADERIPLTE
!define MUI_HEADERIPLTE_RIGHT
!define MUI_HEADERIPLTE_BITMAP "../share/pixmaps/nsis-header.bmp"
...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin\plutus\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
