...
// if DNS seeds are not available (magdns1-3.plutuswork.io).
static void getHardcodedSeeds(std::vector<CAddress> &vSeedsOut)
{
    ...
    {
        CAddress addr(CService(ips[i], 18121));
...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "The New Coin On The Block: Jan 25, 2018";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1516914799;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact(); 
        genesis.nNonce   = 22270;
        ...
        assert(hashGenesisBlock == uint256("0x0000d1b7fe6c3fc7e375874e2c5177fe3ca1b81fb21567aa8bef56d0ee2f8da1"));
        assert(genesis.hashMerkleRoot == uint256("0x1a23ade0dfef8c977ee1c947ab79197cdd0b5ca3e2a7ade091178d75a77d30e6"));
        ...
        vSeeds.push_back(CDNSSeedData("First",  "magdns1.plutuswork.io"));
        vSeeds.push_back(CDNSSeedData("Second",  "magdns2.plutuswork.io"));
        vSeeds.push_back(CDNSSeedData("Third",  "magdns3.plutuswork.io"));
